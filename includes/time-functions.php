...
function zp_get_i18n_months( $key = '' ) {
	$months = array(
		'1'		=> __( 'Jänner', 'zodiacpress' ),
		'2'		=> __( 'Februar', 'zodiacpress' ),
		'3'		=> __( 'März', 'zodiacpress' ),
		'4'		=> __( 'April', 'zodiacpress' ),
		'5'		=> __( 'Mai', 'zodiacpress' ),
		'6'		=> __( 'Juni', 'zodiacpress' ),
		'7'		=> __( 'Juli', 'zodiacpress' ),
		'8'		=> __( 'August', 'zodiacpress' ),
		'9'		=> __( 'September', 'zodiacpress' ),
		'10'	=> __( 'Oktober', 'zodiacpress' ),
		'11'	=> __( 'November', 'zodiacpress' ),
		'12'	=> __( 'Dezember', 'zodiacpress' )
	);
