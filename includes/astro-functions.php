...
function zp_get_planets( $houses = '', $include = '' ) {
	$planets = apply_filters( 'zp_get_planets', array(
		array(
			'id'		=> 'sun',
			'label'		=> __( 'Sonne', 'zodiacpress' ),
			'supports'	=> array( 'houses' )
		),
		array(
			'id'		=> 'moon',
			'label'		=> __( 'Mond', 'zodiacpress' ),
			'supports'	=> array( 'houses', 'birth_time_required' )
		),
		array(
			'id'		=> 'mercury',
			'label'		=> __( 'Merkur', 'zodiacpress' ),
			'supports'	=> array( 'houses' )
		),
		array(
			'id'		=> 'venus',
		...
		array(
			'id'		=> 'lilith',
			'label'		=> __( 'Schwarzer Mond Lilith', 'zodiacpress' ),
			'supports'	=> array( 'houses' )
		),
		array(
			'id'		=> 'nn',
			'label'		=> __( 'Nordknoten', 'zodiacpress' ),
			'supports'	=> array( 'houses' ) // true lunar node
		),
		array(
			'id'		=> 'pof',
			'label'		=> __( 'Teil des Glücks', 'zodiacpress' ),
			'supports'	=> array( 'houses', 'birth_time_required' )
		),
		array(
			'id'		=> 'vertex',
			'label'		=> __( 'Scheitel', 'zodiacpress' ),
			'supports'	=> array( 'houses', 'birth_time_required' )
		),
		array(
			'id'		=> 'asc',
			'label'		=> __( 'Aszendent', 'zodiacpress' ),
			'supports'	=> array( 'birth_time_required' )
		),
		array(
			'id'		=> 'mc',
			'label'		=> __( 'Himmelsmitte', 'zodiacpress' ),
			'supports'	=> array( 'birth_time_required' )
		)// 16
	) );
	if ( $houses ) {
...
function zp_get_aspects() {
	$aspects = array(
		array(
			'id'		=> 'conjunction',
			'label'		=> __( 'Verbindung', 'zodiacpress' ),
			'numerical'	=> '0' ),
		array(
			'id'		=> 'sextile',
			'label'		=> __( 'Sextil', 'zodiacpress' ),
			'numerical'	=> 60 ),
		array(
			'id'		=> 'square',
			'label'		=> __( 'Quadrat', 'zodiacpress' ),
			'numerical'	=> 90 ),
		array(
			'id'		=> 'trine',
			'label'		=> __( 'Trigon', 'zodiacpress' ),
			'numerical'	=> 120 ),
		array(
			'id'		=> 'quincunx',
...
function zp_get_zodiac_signs() {
	$signs = array(
			array(
				'id'	=> 'aries',
				'label'	=> __( 'Widder', 'zodiacpress' ) ),
			array(
				'id'	=> 'taurus',
				'label'	=> __( 'Stier', 'zodiacpress' ) ),
			array(
				'id'	=> 'gemini',
				'label'	=> __( 'Zwillinge', 'zodiacpress' ) ),
			array(
				'id'	=> 'cancer',
				'label'	=> __( 'Krebs', 'zodiacpress' ) ),
			array(
				'id'	=> 'leo',
				'label'	=> __( 'Löwe', 'zodiacpress' ) ),
			array(
				'id'	=> 'virgo',
				'label'	=> __( 'Jungfrau', 'zodiacpress' ) ),
			array(
				'id'	=> 'libra',
				'label'	=> __( 'Waage', 'zodiacpress' ) ),
			array(
				'id'	=> 'scorpio',
				'label'	=> __( 'Skorpion', 'zodiacpress' ) ),
			array(
				'id'	=> 'sagittarius',
				'label'	=> __( 'Schütze', 'zodiacpress' ) ),
			array(
				'id'	=> 'capricorn',
				'label'	=> __( 'Steinbock', 'zodiacpress' ) ),
			array(
				'id'	=> 'aquarius',
				'label'	=> __( 'Wassermann', 'zodiacpress' ) ),
			array(
				'id'	=> 'pisces',
				'label'	=> __( 'Fische', 'zodiacpress' ) )
	);
	return $signs;
}
/**
